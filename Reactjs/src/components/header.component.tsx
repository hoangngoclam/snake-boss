...
function DropdownItems() {
    ...
    return (
        <div
            className="dropdown-box w-40 flex p-2 flex-col bg-white rounded-md absolute 
        ...
        >
            ...
            <a
                href="#"
                className="py-1 text-center text-gray-600 hover:bg-gray-200 hover:text-gray-800"
                onClick={onSighOutClick}
            >
                Đăng xuất
            </a>
        </div>
...
function GetAvatarUrl() {
    const currentUser: IUserModel = JSON.parse(localStorage.getItem('user') || 'null');
    if (currentUser === null) {
