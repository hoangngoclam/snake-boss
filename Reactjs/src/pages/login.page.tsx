...
export default function LoginPage(props: any) {
    ...
    const submitForm = () => {
        if (errorEmail === '') {
            const data: IDataPostLogin = { email: email, password: password };
            API.Post('http://localhost:5000/user/login', data)
                .then((result: any) => {
                    const dataResult = result.data as IDataReceiveLogin;
    ...
    return (
        <div className=" w-full lg:w-4/12 md:w-4/12 sm:w-10/12 mx-auto items-center flex justify-center h-screen">
            <div className="py-10 px-12 border border-gray-400 w-full shadow-md">
                ...
                <InputComponent
                    ...
                    value={password}
                    onChangeEvent={onPasswordChange}
                />
                ...
                <div className="flex items-center mb-6 -mt-4">
                    ...
                    <div className="flex ml-auto">
                        <Link
                            to="#"
                            onClick={() => {
                                alert('This function is developed');
                            }}
                            className="inline-flex text-xs sm:text-sm text-blue-500 hover:text-blue-700"
                        >
